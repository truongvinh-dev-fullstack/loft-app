...
export const MaintenanceInformation = observer(function MaintenanceInformation() {
    const navigation = useNavigation();
    // const {movesModel} = useStores();
    const [isLoading, setLoading] = useState(false);
    const [model_baotri, setmodel_baotri] = useState(false);
        ...
        return (
            <View>             
                <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginHorizontal: 16, marginTop: 16, marginBottom: 16,}}>
                    ...
                    <MButton text='Thêm' style={[styles.btnWrapper, {width: '25%'}]} onPress={() => setmodel_baotri(true)}/>
                </View> 
            </View>
        );
    };
            ...
            <View>
                 <View style={styles.box}>
                         <View style={{marginBottom: 10}}>
                            <Text>20/08/2022 - 25/08/2022</Text>
                         </View>
                         <View style={styles.item}>
                            <Text style={{width: layout.width/10 * 2}}>Phụ trách:</Text>
                            <Text style={{width: layout.width/10 * 7}}>BM123-Nguyễn Văn A</Text>
                         </View>
                         <View style={styles.item}>
                            <Text style={{width: layout.width/10 * 2}}>Lý do:</Text>
                            <Text style={{width: layout.width/10 * 7}}>Thích thì bảo trì, ok khum!</Text>
                         </View>
                      </View>
            </View>
        )
                                ...
                                <FlatList
                                    ...
                                    ListHeaderComponent={() => {
                                        return (
                                            <View>
                                                <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginHorizontal: 16, marginTop: 16, marginBottom: 16}}>
                                                    <TouchableOpacity style={styles.backWrapper} onPress={() => setmodel_baotri(false)}>
                                                        <Ionicons name='arrow-back-outline' color={color.white} size={30}/>
                                                    </TouchableOpacity>
                                                    <Text style={{fontSize: 17, textTransform: 'capitalize'}} fonts={'DemiBold'}>Cấp phát tài sản</Text>
                                                    <MButton text='Lưu' style={[styles.btnWrapper, {width: '20%'}]} onPress={() => setmodel_baotri(true)}/>
                                                </View>
